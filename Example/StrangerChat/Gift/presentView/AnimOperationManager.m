...
#define PresentViewY ([UIScreen mainScreen].bounds.size.height - 363)
#define PresentViewH 48
#define PresentViewW 188
    ...
    if ([self.userGigtInfos objectForKey:userID]) {
        ...
        if ([userID integerValue] % 2) {
            ...
            if (op.model.giftCount != 0) {
                op.presentView.frame  = CGRectMake(-PresentViewW, PresentViewY, PresentViewW, PresentViewH);
            ...
            if (op.model.giftCount != 0) {
                op.presentView.frame  = CGRectMake(-PresentViewW, 200, PresentViewW, PresentViewH);
                op.presentView.originFrame = op.presentView.frame;
